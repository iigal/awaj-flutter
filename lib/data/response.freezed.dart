...
abstract class $ApiResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool success, String? message, List<dynamic> data});
}
...
class _$ApiResponseImpl implements _ApiResponse {
  _$ApiResponseImpl(
      {required this.success, this.message, required final List<dynamic> data})
      : _data = data;
...
abstract class _PaginatedResponse<T> implements PaginatedResponse<T> {
  const factory _PaginatedResponse(
      ...
      final int? totalPages,
      final int? totalItems,
      final List<T>? items}) = _$PaginatedResponseImpl<T>;
